"""A selection of optimisation algorithms, largely based off scipy algorithms."""
'''
cdef public findRoot(f, double x0, double x1, double tolAbs, double tolRel, unsigned short maxIter, tuple args):
    """Brent's method root finding using inverse quadratic interpolation. Based directly off scipy brentq function, written by Charles Harris: `<https://docs.scipy.org/doc/scipy-0.18.1/reference/generated/scipy.optimize.brentq.html>`_"""
    unsigned short i = 0
    double f0, f1, fprev,tol
