...
from ..bases.solidmaterial import SolidMaterial
...
def alumel(T=293.15):
    return SolidMaterial(
        rho=8600.,
        data={'T': [373.15, 473.15, 573.15, 673.15],
              'k': [30, 32, 35, 38]},
        deg=-1,
        T=T,
        name="alumel",
...
def aluminium(T=293.15):
    return SolidMaterial(
        rho=2707.,
        data={
            'T': [
                103.15, 173.15, 273.15, 293.15, 373.15, 473.15, 573.15, 673.15,
                873.15
            ],
            'k': [302, 242, 236, 237, 240, 238, 234, 228, 215]
        },
        deg=-1,
        T=T,
        name="aluminium",
...
def aluminium_6061_T6(T=293.15):
    return SolidMaterial(
        rho=2700.,
        data={
            'T': [273.15, 293.15, 373.15, 473.15, 573.15],
            'k': [166, 167, 172, 177, 180]
        },
        deg=-1,
        T=T,
...
def aluminium_7075_T6(T=293.15):
    return SolidMaterial(
        rho=2800.,
        data={
            'T': [103.15, 173.15, 273.15, 293.15, 373.15, 473.15, 573.15],
            'k': [76, 100, 121, 130, 137, 172, 177]
        },
        deg=-1,
        T=T,
...
def brass(T=293.15):
    return SolidMaterial(
        ...
        data={
            'T':
            [103.15, 173.15, 273.15, 293.15, 373.15, 473.15, 573.15, 673.15],
            'k': [73, 89, 106, 109, 133, 143, 146, 147]
        },
        deg=-1,
        T=T,
        name="brass",
        notes=
        "brass (Cu, 30%-Zn), from Table A.1; Lienhard, J. H. I. & Lienhard, J. H. V. A Heat Transfer Textbook Phlogiston Press, 2011"
    )


#: Chromel P (Ni, 10%-Cr), from Table A.1; Lienhard, J. H. I. & Lienhard, J. H. V., *A Heat Transfer Textbook*, Phlogiston Press, 2011.
def chromelP(T=293.15):
    return SolidMaterial(
        rho=8730.,
        data={'T': [373.15, 473.15, 573.15, 673.15],
              'k': [19, 21, 23, 25]},
...
def chromium(T=293.15):
    return SolidMaterial(
        rho=7190.,
        data={
            'T': [
                103.15, 173.15, 273.15, 293.15, 373.15, 473.15, 573.15, 673.15,
                873.15, 1073.15, 1273.15
            ],
            'k': [158, 120, 95, 90, 88, 85, 82, 77, 69, 64, 62]
        },
        deg=-1,
        T=T,
        name="chromium",
...
def constantan(T=293.15):
    return SolidMaterial(
        rho=8922.,
        data={
            'T': [103.15, 173.15, 273.15, 293.15, 373.15, 473.15],
            'k': [17, 19, 22, 22, 26, 35]
        },
        deg=-1,
        T=T,
        name="constantan",
        notes=
        "constantan (Cu, 40%-Ni), from Table A.1; Lienhard, J. H. I. & Lienhard, J. H. V. A Heat Transfer Textbook Phlogiston Press, 2011"
    )
...
def copper(T=293.15):
    return SolidMaterial(
        ...
        data={
            ...
            'k': [483, 420, 401, 398, 391, 389, 384, 378, 366, 352, 336]
        },
        deg=-1,
        T=T,
        name="copper",
...
def duralumin(T=293.15):
    return SolidMaterial(
        rho=2787.,
        data={
            'T': [173.15, 273.15, 293.15, 373.15, 473.15],
            'k': [126, 164, 164, 182, 194]
        },
        deg=-1,
        T=T,
        name="duralumin",
        notes=
        "duralumin (4%-Cu, 0.5%-Mg), from Table A.1; Lienhard, J. H. I. & Lienhard, J. H. V. A Heat Transfer Textbook Phlogiston Press, 2011"
    )
...
def gold(T=293.15):
    return SolidMaterial(
        ...
        data={
            ...
            'k': [327, 324, 319, 318, 313, 306, 299, 293, 279, 264, 249]
        },
        deg=-1,
        T=T,
        name="gold",
...
def inconelX750(T=293.15):
    return SolidMaterial(
        ...
        data={
            ...
            'k':
            [8.8, 10.6, 11.3, 11.6, 13.0, 14.7, 16.0, 18.3, 21.8, 25.3, 29]
        },
        deg=-1,
        T=T,
        name="inconelX750",
...
def iron(T=293.15):
    return SolidMaterial(
        ...
        data={
            ...
            'k': [132, 98, 84, 80, 72, 63, 56, 50, 39, 30, 29.5]
        },
        deg=-1,
        T=T,
        name="iron",
...
def magnesium(T=293.15):
    return SolidMaterial(
        ...
        data={
            ...
            'k': [169, 160, 157, 156, 154, 152, 150, 148, 145]
        },
        deg=-1,
        T=T,
        name="magnesium",
...
def molybdenum(T=293.15):
    return SolidMaterial(
        ...
        data={
            ...
            'k': [175, 146, 139, 138, 135, 131, 127, 123, 116, 109, 103]
        },
        deg=-1,
        T=T,
        name="molybdenum",
...
def nichromeV(T=293.15):
    return SolidMaterial(
        rho=8410.,
        data={
            'T':
            [293.15, 373.15, 473.15, 573.15, 673.15, 873.15, 1073.15, 1273.15],
            'k': [10, 11, 13, 15, 17, 20, 24]
        },
        deg=-1,
        T=T,
        name="nichromeV",
...
def nickel(T=293.15):
    return SolidMaterial(
        ...
        data={
            ...
            'k': [156, 114, 94, 91, 83, 74, 6, 64, 69, 73, 78]
        },
        deg=-1,
        T=T,
        name="nickel",
...
def steel_1010(T=293.15):
    return SolidMaterial(
        rho=7830.,
        data={
            'T': [
                173.15, 273.15, 293.15, 373.15, 473.15, 573.15, 673.15, 873.15,
                1073.15
            ],
            'k': [70, 65, 64, 61, 55, 50, 45, 36, 29]
        },
        deg=-1,
        T=T,
        name="steel_1010",
...
def stainlessSteel_304(T=293.15):
    return SolidMaterial(
        rho=8000.,
        data={
            'T': [293.15, 373.15, 473.15, 573.15, 673.15, 873.15],
            'k': [13.8, 15, 17, 19, 21, 25]
        },
        deg=-1,
        T=T,
...
def stainlessSteel_316(T=293.15):
    return SolidMaterial(
        rho=8000.,
        data={
            'T': [
                173.15, 293.15, 373.15, 473.15, 573.15, 673.15, 873.15,
                1073.15, 1273.15
            ],
            'k': [12, 13.5, 15, 16, 17, 19, 21, 24, 26]
        },
        deg=-1,
        T=T,
...
def stainlessSteel_347(T=293.15):
    return SolidMaterial(
        rho=8000.,
        data={
            'T': [
...
def silicon(T=293.15):
    return SolidMaterial(
        ...
        data={
            ...
            'k': [856, 342, 168, 153, 112, 82, 66, 54, 38, 29, 25]
        },
        deg=-1,
        T=T,
        name="silicon",
...
def silver(T=293.15):
    return SolidMaterial(
        ...
        data={
            ...
            'k': [449, 431, 428, 427, 422, 417, 409, 401, 386, 370]
        },
        deg=-1,
        T=T,
        name="silver",
...
def titanium(T=293.15):
    return SolidMaterial(
        ...
        data={
            ...
            'k': [31, 26, 22, 22, 21, 20, 20, 19, 21, 21, 22]
        },
        deg=-1,
        T=T,
        name="titanium",
...
def titanium_6Al4V(T=293.15):
    return SolidMaterial(
        rho=4430.,
        data={
            'T': [293.15, 373.15, 473.15, 573.15, 673.15],
            'k': [7.1, 7.8, 8.8, 10., 12.]
        },
        deg=-1,
        T=T,
...
def tungsten(T=293.15):
    return SolidMaterial(
        ...
        data={
            ...
            'k': [235, 223, 182, 178, 166, 153, 141, 134, 125, 122, 114]
        },
        deg=-1,
        T=T,
        name="tungsten",
...
def zinc(T=293.15):
    return SolidMaterial(
        ...
        data={
            'T':
            [103.15, 173.15, 273.15, 293.15, 373.15, 473.15, 573.15, 673.15],
            'k': [124, 122, 122, 121, 117, 110, 106, 100]
        },
        deg=-1,
        T=T,
        name="zinc",
