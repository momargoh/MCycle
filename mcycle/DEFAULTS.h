...
__PYX_EXTERN_C double RUN_BRACKET_MIN_H;
__PYX_EXTERN_C double RUN_BRACKET_MAX_H;
__PYX_EXTERN_C double GRAVITY;
__PYX_EXTERN_C PyObject *COOLPROP_EOS;
__PYX_EXTERN_C PyObject *MPL_BACKEND;
__PYX_EXTERN_C PyObject *PLOT_DIR;
__PYX_EXTERN_C int PLOT_DPI;
__PYX_EXTERN_C PyObject *PLOT_FORMAT;
